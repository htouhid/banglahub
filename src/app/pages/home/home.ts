...
@Component({
  selector: 'app-home',
  imports: [Events, Housing, ServicesPromo, CommunityJobsCarousel, CityHeroSlider, LocalWeatherComponent, LocalNewsComponent, RouterLink, MatTabsModule, Restaurants, Groceries],
